...
class TestViews(TestCase):
    ...
    def test_expens_create_required_fields_missing(self):
        payload = {
            "merchant": "AT&T",
            "description": "cell phone",
            "category": "utilities",
    ...
    def test_expense_retrieve(self):
        expense = models.Expense.objects.create(
            amount=100, merchant="George", description="loan", category="transfer"
        )
        res = self.client.get(
    ...
    def test_list_expense_filter_by_merchant(self):
        amazon_expense = models.Expense.objects.create(
            amount=100, merchant="amazon", description="sunglases", category="fashion"
        )
